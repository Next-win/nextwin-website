...
export const caseStudiesData: CaseStudy[] = [
  ...
  {
    id: 'natuurcentrumginkel',
    title: 'Natuurcentrum de Ginkel',
    category: 'WordPress & E-commerce',
    imageSrc: '/cases/natuurcentrumginkel/thumbnail.jpg',
    rating: 5,
    statLabel: 'Bezoekers',
    statValue: '+125%',
    description: 'Complete herontwerp en ontwikkeling van website met e-commerce functionaliteit, evenementenbeheer en moderne gebruikerservaring.',
    slug: 'natuurcentrumginkel',
  },
  {
    id: 'access-safety',
    title: 'Access Safety',
